...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-aws-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-aws-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add terraform-provider-aws
# for installing globally
pixi global install terraform-provider-aws
```
...
It is possible to list all of the versions of `terraform-provider-aws` available on your platform:
...
```
pixi search terraform-provider-aws --channel conda-forge
```
